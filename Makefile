...
REGRESS      = test_v071 test_v080 test_v0110_typed_recall test_remember_fact test_v0120 typed_recall_fast test_v0142_curation_honesty test_v0150_episodic test_v0151_guc_situation test_v0160_entity_keys test_v0161_failure_vocab
