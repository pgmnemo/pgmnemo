...
|---|---|---|---|
| POS-VC-PGM | startup_mentor (91) as VC consultant | 6312 | ✅ DONE (TL-rescued from worktree zombie) |
| POS-WEDGE-PGM | product_owner (16) | 6313 | ✅ DONE (TL-rescued) |
| POS-MARKET-PGM | growth_lead (92) v2 | 6314 | ✅ DONE (TL-rescued) |
| POS-DEFENSE-PGM | chief_architect (86) v2 | 6315 | ✅ DONE (TL-rescued) |
| POS-DATA-PGM | principal_investigator (77) | 6316 | ✅ DONE (TL-rescued) |
| EA-FETCH (Sheets) | executive_assistant (4) | 6311 | ✅ DONE (OAuth failed via MCP; TL fetched via Chrome MCP, commit 8c44419) |
