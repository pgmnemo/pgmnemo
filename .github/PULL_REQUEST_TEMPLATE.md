...
|---|---|---|
| technical_lead (5) | All schema / retrieval changes | `[ ]` LGTM |
| experiment_designer (84) | Bench protocol changes + BENCH stage GO/NO-GO | `[ ]` LGTM |
| research_supervisor (85) | Statistical methodology changes | `[ ]` LGTM |
| principal_investigator (77) | Ship/hold decision (release PRs only) | `[ ]` SHIP / HOLD |
| process_guardian (78) | Phantom-DONE check: all listed files exist on disk | `[ ]` Verified |
