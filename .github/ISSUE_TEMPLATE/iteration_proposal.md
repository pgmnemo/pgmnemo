...
- [ ] experiment_designer (84) — bench impact estimates validated
- [ ] process_guardian (78) — task specs complete (evidence threshold + rollback criteria present)

Optional (confirm attendance at WG checkpoints):
- [ ] research_supervisor (85)
- [ ] technical_lead (5)
- [ ] startup_mentor (91)
- [ ] growth_lead (92)
- [ ] prompt_master (76)
