-- pgmnemo--0.18.0.sql
-- Flat install for pgmnemo 0.18.0 (auto-promotion: draft → validated by confirmed benefit)
-- Generated from: pgmnemo--0.17.0.sql + pgmnemo--0.17.0--0.18.0.sql
-- SPDX-License-Identifier: Apache-2.0

\echo Use "CREATE EXTENSION pgmnemo VERSION '0.18.0'" to load this file. \quit
