-- pgmnemo--0.15.0.sql
-- Flat install for pgmnemo 0.15.0 (episodic recall — situation fingerprints; RECLASSIFICATION CONTRACT on typed write verbs)
...
\echo Use "CREATE EXTENSION pgmnemo VERSION '0.15.0'" to load this file. \quit
