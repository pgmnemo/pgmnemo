-- pgmnemo--0.10.1.sql
-- Flat install: pgmnemo 0.10.1
-- Generated from pgmnemo--0.10.0.sql + pgmnemo--0.10.0--0.10.1.sql
-- SPDX-License-Identifier: Apache-2.0
--
-- Install: CREATE EXTENSION pgmnemo;
-- Upgrade: ALTER EXTENSION pgmnemo UPDATE TO '0.10.1';
--
-- v0.10.1 (#87): recall_hybrid robustness
--   Fix 1: cap query_text to ≤200 chars for BM25 (embedding carries full semantics)
--   Fix 2: use indexed full_text @@ _tsquery (removes per-row to_tsvector(topic))
--   Fix 3: per-signal BM25 time budget (pgmnemo.bm25_budget_ms, default 250ms)
--          with graceful degradation to vector-only on timeout
--   Fix 4: tsconfig 'simple' for RU/EN/code mixed corpus
