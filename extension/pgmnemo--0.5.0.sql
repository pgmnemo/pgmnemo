-- pgmnemo 0.5.0 — flat install script (fresh CREATE EXTENSION target)
-- Squashes the full upgrade chain 0.0.1 → 0.5.0 into a single idempotent DDL file.
...
-- Generated 2026-05-17 — do not edit manually; maintain via upgrade scripts.
-- ─────────────────────────────────────────────────────────────────────────────
