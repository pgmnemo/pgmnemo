-- pgmnemo--0.9.5.sql
-- Flat install: pgmnemo v0.9.5
-- SPDX-License-Identifier: Apache-2.0
--
-- Squashes the full upgrade chain 0.0.1 → 0.9.5 into a single idempotent DDL file.
...
-- =============================================================================
-- v0.9.5 FINAL OVERRIDES: recall_hybrid, recall_lessons, mark_stale
