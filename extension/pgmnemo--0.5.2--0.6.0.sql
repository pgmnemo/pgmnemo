-- pgmnemo 0.5.2 → 0.6.0 upgrade migration
-- NOTE: v0.5.2 was a Python packaging / docs fix only (no SQL schema change).
-- The SQL extension version did not advance past 0.5.1 in the 0.5.2 release.
