-- pgmnemo--0.14.1.sql
-- Flat install for pgmnemo 0.14.1 (HNSW planner regression fix: recall_hybrid vec-candidate fetch via EXECUTE)
-- Generated from: pgmnemo--0.14.0.sql + pgmnemo--0.14.0--0.14.1.sql
