-- pgmnemo--0.9.0.sql
-- Flat install: pgmnemo v0.9.0
-- SPDX-License-Identifier: Apache-2.0
--
-- Squashes the full upgrade chain 0.0.1 → 0.9.0 into a single idempotent DDL file.
...
-- Generated 2026-06-10 — do not edit manually; maintain via upgrade scripts.
-- ─────────────────────────────────────────────────────────────────────────────
...
BEGIN
    ...
    raw_candidates AS (
        ...
        WHERE al.is_active
          ...
          -- Union: any candidate matched by vector OR BM25 (including topic match)
          AND (
...
BEGIN
    ...
    raw_candidates AS (
        ...
        WHERE al.is_active
          ...
          -- #1b: project_id_filter — uses B-tree index pgmnemo_agent_lesson_project_idx
          AND (project_id_filter IS NULL OR al.project_id = project_id_filter)
